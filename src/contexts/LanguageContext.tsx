...
const translations = {
  en: {
    ...
    "dashboard.feeDescription": "Our management fee is a flat 5% of all returns.",
    "dashboard.launchBonusActive": "Launch Bonus: no management fees!",
  ...
  ja: {
    ...
    "dashboard.feeDescription": "管理手数料は全てのリターンの一律5%です。",
    "dashboard.launchBonusActive": "ローンチボーナス：管理手数料無料！",
    ...
    "landing.intro2": "銀行口座と同様に機能しますが、安定で確実に所得を増やす",
    "landing.card1": "平均",
