...
const translations = {
  ...
  ja: {
    ...
    "dashboard.dynamicRateDescription":
      "このAPYは、分散型金融（DeFi）プロトコル全体の貸付金利に基づいてリアルタイムで更新され、市場状況に応じて常に変動します。",
    ...
    "dashboard.step4Description":
      "お客様の資金とデータのセキュリティを確保するため、スマートコントラクト監査など、予防措置を講じています。",
    ...
    "withdraw.whyDifferentText1":
      "Perkloopは日本円を米ドルステーブルコインに変換して収益を生み出すため、出金額は為替レートの変動によって変わります。",
    "withdraw.whyDifferentText2":
