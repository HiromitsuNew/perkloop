...
const translations = {
  ...
  ja: {
    ...
    "landing.card1.bold.suffix": " で貯蓄",
    "landing.card1.disclaimer": "DeFiレンディングの年初来平均値であり、変化する可能性があります",
    "landing.card2": "市場状況に関わらず元本を",
    "landing.card2.bold": "絶対に失わない",
    "landing.card2.disclaimer": "XXX",
    "landing.card3": "いつでも",
    "landing.card3.bold": "引き出し可能",
    "landing.card3.disclaimer": "XXX",
    "landing.card4": "利益を",
    "landing.card4.bold": "ワンクリック",
    "landing.card4.bold.suffix": "で受け取り",
    "landing.card4.disclaimer": "XXX",
