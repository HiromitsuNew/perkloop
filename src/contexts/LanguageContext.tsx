...
const translations = {
  ...
  ja: {
    ...
    "dashboard.resetDescription": "すべての投資と履歴が完全に削除されます。この操作は元に戻せません。",
    ...
    "dashboard.step1Description": "あなたの日本円預金をステーブルコイン（USDC）の形で米ドルに換金します。",
    "dashboard.step1Bold": "USDCは、米ドルと同じ価値を維持するように設計された仮想通貨である。",
    ...
    "riskMitigation.risk1.mitigation3.text":
      "ハッキングが発生した場合、直ちにL1チェーン財団（例：Sui Foundation）とプロトコルのガバナンスコミュニティ（DAO）に働きかけ、法的・技術的な取り組みを全面的に展開し、コミュニティ資金による資産回復または補償の可能性を最大化します。過去に振り返りますと、主要なL1チェーンとプロトコルは失われた投資家資本を回復し補償するケースが多くあります。私たちはあなたの代弁者として、利用可能なすべての外部回復を確保することを約束します。",
