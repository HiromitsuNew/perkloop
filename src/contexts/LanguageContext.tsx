...
const translations = {
  en: {
    ...
    'dashboard.step4Description': 'We take extra precautions to increase the security of your funds and data through advanced blockchain technology and rigorous security protocols.',
    ...
    'withdraw.whyDifferentText1': 'Perkloop converts your JPY into USD stablecoin to generate returns, so your withdrawal amount is affected by exchange rate fluctuations.',
    'withdraw.whyDifferentText2': 'If JPY strengthens against USD after your deposit, you may withdraw less than your original deposit amount.',
    'withdraw.whyDifferentText3': 'If JPY weakens against USD after your deposit, you may withdraw more than your original deposit amount.',
    'withdraw.whatIfLessTitle': 'What if my withdrawal amount is less than my original deposit?',
    'withdraw.whatIfLessText': 'You can wait and withdraw later when JPY weakens against USD. Your withdrawal amount may increase and potentially exceed your original deposit.',
  ...
  ja: {
    ...
    'dashboard.step3Point2': '元本が減ることはありません',
    'dashboard.step3Point3': '初日から利息が発生します',
    'dashboard.step4Title': 'セキュリティを最優先',
    'dashboard.step4Description': '高度なブロックチェーン技術と厳格なセキュリティプロトコルにより、お客様の資金とデータのセキュリティを向上させるために特別な予防措置を講じています。',
    ...
    'withdraw.whyDifferentText1': 'Perkloopは日本円を米ドルステーブルコインに変換してリターンを生成するため、出金額は為替レートの変動の影響を受けます。',
    'withdraw.whyDifferentText2': '預金後に円が対ドルで強くなった場合、元の預金額よりも少ない金額を出金することになる可能性があります。',
    'withdraw.whyDifferentText3': '預金後に円が対ドルで弱くなった場合、元の預金額よりも多い金額を出金できる可能性があります。',
    'withdraw.whatIfLessTitle': '出金額が元の預金額より少ない場合はどうすればよいですか？',
    'withdraw.whatIfLessText': '円が対ドルで弱くなるまで待ってから出金することができます。出金額が増加し、元の預金額を超える可能性もあります。',
