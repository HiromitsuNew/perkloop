...
const translations = {
  en: {
    ...
    "landing.intro2": "Works like any other bank account, expect it pays your bills.",
    "landing.card1": "Enjoy ",
    "landing.card1.bold": "9% APY",
    "landing.card1.suffix": " on your savings",
    "landing.card1.disclaimer": "Year-to-date DeFi lending average, subject to change",
    "landing.card2": "Never lose ",
    "landing.card2.bold": "your principal",
    "landing.card2.suffix": " regardless of market conditions",
    "landing.card2.disclaimer": "Your principal never decreases. Up to ￥1 million insured against cyberattacks.",
    "landing.card3": "Full withdrawal of principal within ",
    "landing.card3.bold": "24 hours",
    "landing.card3.suffix": "",
    "landing.card3.disclaimer": "100% liquid, one-click to withdraw to your bank account",
    "landing.card4": "Take profit as soon as ",
    "landing.card4.bold": "1 week",
  ...
  ja: {
    ...
    "landing.intro2": "他の銀行口座と同じように機能しますが、請求書の支払いが可能です。",
    "landing.card1": "平均 ",
    "landing.card1.bold": "9%のAPY",
    "landing.card1.suffix": " で貯蓄",
    "landing.card1.disclaimer": "DeFiレンディングの年初来平均値であり、変化する可能性があります",
    "landing.card2": "",
    "landing.card2.bold": "元本を絶対に失わない",
    "landing.card2.suffix": "、市場状況に関わらず",
    "landing.card2.disclaimer": "XXX",
    "landing.card3": "元本の全額を",
    "landing.card3.bold": "24時間以内",
    "landing.card3.suffix": "に引き出し",
    "landing.card3.disclaimer": "XXX",
    "landing.card4": "預金後わずか",
    "landing.card4.bold": "1週間",
    "landing.card4.suffix": "で利益を受け取る",
    "landing.card4.disclaimer": "XXX",
