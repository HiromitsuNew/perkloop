...
const translations = {
  en: {
    ...
    "dashboard.step4Footer": "Your investment is protected at every step",
    ...
    "paymentProcess.withdrawDescription":
      "Please withdraw ￥{amount} from your existing {product} investment to reduce it.",
    ...
    "paymentProcess.duplicateDescription":
      "You already have an investment for {product} with ￥{amount} deposited. Would you like to update your existing investment?",
    ...
    "riskMitigation.risk1.mitigation1.text":
      "We invest in high-quality security audits every quarter and deploy assets across 2-3 separate, highly reputable lending protocols (measured by size and stability) on Sui, a blockchain created by a safe programming language.",
    "riskMitigation.risk1.mitigation2.title": "Investor Protection Fund (IPF):",
    "riskMitigation.risk1.mitigation2.text":
      "We establish the Investor Protection Fund (IPF), backed by our firm's segregated capital, to cover 20% of your loss if a hack occurs. This is your immediate safety net.",
  ...
  ja: {
    ...
    "dashboard.resetWarning": "⚠️ 管理者から許可されている場合を除き、この機能を使用しないでください。",
    ...
    "dashboard.dynamicRateDescription":
      "APYは、分散型金融（DeFi）プロトコル全体のレンディング金利に基づいてリアルタイムで更新され、市場状況によって常に変動します。",
    "dashboard.loadingAPY": "APYデータを読み込み中...",
    "dashboard.apyError": "APYデータを読み込めません",
    "dashboard.pending": "保留中",
    "dashboard.noInvestments": "進行中の投資はありません。お金を働かせるために、欲しい商品を選んでください。",
    "dashboard.returnsDialogTitle": "あなたのリターン",
    "dashboard.returnsDialogDescription": "APYと手数料体系の詳細を表示",
    "dashboard.howItWorksButton": "収益をどう生み出す？",
    "dashboard.howItWorksTitle": "仕組みについて",
    "dashboard.howItWorksDescription": "利益を生み出す仕組みを学ぶ",
    "dashboard.step1Title": "ステップ1：通貨変換",
    "dashboard.step1Description": "あなたの日本円預金をステーブルコイン（USDC）の形で米ドルに交換します。",
    "dashboard.step1Bold": "USDCは、米ドルと同じ価値を維持するように設計された暗号通貨である",
    "dashboard.step2Title": "ステップ2：DeFiレンディング",
    "dashboard.step2Description": "あなたのUSDCは",
    "dashboard.step2Bold": "さまざまなDeFi参加者に貸し出され",
    "dashboard.step2Description2": "ブロックチェーン上のDeFiプロトコルを通じて資産運用されます。",
    "dashboard.step3Title": "ステップ3：継続的なリターン",
    "dashboard.step3Description": "このレンディングプロセスは",
    "dashboard.step3Bold": "継続的に収益を生み出し",
    "dashboard.step3Description2": "、以下を保証します：",
    "dashboard.step3Point1": "いつでも元本を引き出せます",
    "dashboard.step3Point2": "元本は減りません",
    "dashboard.step3Point3": "初日から利息が発生します",
    "dashboard.step4Title": "セキュリティを最優先",
    "dashboard.step4Description":
      "高度なブロックチェーン技術と厳格なセキュリティプロトコルにより、お客様の資金とデータのセキュリティを向上させるために特別な予防措置を講じています。",
    "dashboard.step4Footer": "あなたの投資はすべてのステップで保護されています",
    ...
    "withdraw.compoundingNote":
      "💡 出金期間を長くすると、複利効果と取引手数料の削減により、より多くのリターンが得られます。",
    "withdraw.confirm": "確認",
    ...
    "withdraw.fullWithdrawal": "48時間以内に全額出金が開始されます。",
    ...
    "withdraw.whyDifferentText1":
      "Perkloopは日本円を米ドルステーブルコインに変換してリターンを生成するため、出金額は為替レートの変動の影響を受けます。",
    "withdraw.whyDifferentText2":
      "預金後に円が対ドルで強くなった場合、元の預金額よりも少ない金額を出金することになる可能性があります。",
    "withdraw.whyDifferentText3":
      "預金後に円が対ドルで弱くなった場合、元の預金額よりも多い金額を出金できる可能性があります。",
    ...
    "paymentProcess.addedToInvestment":
      "{product}の投資に￥{amount}を追加しました。カウントダウンがリセットされました。",
    ...
    "paymentProcess.duplicateDescription":
      "すでに{product}の投資があり、￥{amount}が預けられています。既存の投資を更新しますか？",
    ...
    "riskMitigation.intro":
      "Perkloopへようこそ。当サービスは、分散型金融（DeFi）レンディングへの参加により高いリターンを提供することを目指しています。投資する前に、リスクと当社のリスク緩和策について理解する必要があります。",
    "riskMitigation.warning": "あなたの元本は日本政府や銀行によって保険されていません。",
    "riskMitigation.risk1.title": "1. プロトコル悪用リスク",
    "riskMitigation.risk1.description":
      "あなたの資金は自動化された公開ソフトウェア（スマートコントラクト）によって管理されます。近年セキュリティは大幅に改善されていますが、このコードの欠陥がハッカーによって悪用され、投資元本の最大100％を失う可能性があります。",
    ...
    "riskMitigation.risk1.mitigation1.text":
      "四半期ごとに高品質のセキュリティ監査に投資し、安全なプログラミング言語で作成されたブロックチェーンであるSui上の2〜3の別々の高評価レンディングプロトコル（規模と安定性で測定）に資産を展開します。",
    "riskMitigation.risk1.mitigation2.title": "投資家保護基金（IPF）：",
    "riskMitigation.risk1.mitigation2.text":
      "当社の分離資本に裏付けられた投資家保護基金（IPF）を設立し、ハッキングが発生した場合に損失の20％を補償します。これはあなたの即座の安全網です。",
    "riskMitigation.risk1.mitigation3.title": "完全回復への取り組み：",
    "riskMitigation.risk1.mitigation3.text":
      "ハッキングが発生した場合、直ちにL1チェーン財団（例：Sui Foundation）とプロトコルのガバナンスコミュニティ（DAO）に働きかけ、法的・技術的な取り組みを全面的に展開し、コミュニティ資金による資産回復または補償の可能性を最大化します。歴史的に、主要なL1チェーンとプロトコルは失われた投資家資本を回復し補償するための行動を開始しており、私たちはあなたの不屈の代弁者として、利用可能なすべての外部回復を確保することを約束します。",
    "riskMitigation.risk2.title": "2. 為替リスク",
    "riskMitigation.risk2.description":
      "あなたの預金は利回りを得るために米ドルステーブルコインに変換されます。引き出し時に日本円が強くなっている場合、受け取る円の金額は元の預金額よりも少なくなる可能性があります。ただし、引き出し時に円が弱くなっている場合は、最初の預金額よりも多くの円を受け取ることができます。",
    "riskMitigation.risk2.mitigation": "緩和策",
    "riskMitigation.risk2.mitigationText":
      "赤/緑インジケーターを通じてこのリアルタイムリスクを表示します。この通貨リスクを負担する代わりに、高いグローバル利回りの全潜在力と、為替変動から追加のリターンを得る可能性を受け取ります。",
    ...
    "riskMitigation.risk3.mitigationText":
      "すべての資金はUSDCのみに変換されます。USDCは最も安全で、コンプライアンスに準拠し、評判の高い米ドルペッグステーブルコインであり、ペッグ解除リスクを最小限に抑えます。",
  },
};
